<section class="panel">
    ...
    <div class="panel-body">
        <form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/editpfosubmit");?>' enctype='multipart/form-data'>
                ...
                <div class="col-sm-4">
                    <input type="email" id="normal-field" class="form-control" name="email" value='<?php echo set_value(' email ',$before->email);?>'>
                        ...
                        <div class=" form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea name="message" id="" cols="20" rows="10" class="form-control "><?php echo set_value( 'message',$before->message);?></textarea>
                            </div>
                        </div>
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    ...
                    <a href='<?php echo site_url("site/viewpfo"); ?>' class='btn btn-secondary'>Cancel</a>
                </div>
            </div>
        </form>
    </div>
